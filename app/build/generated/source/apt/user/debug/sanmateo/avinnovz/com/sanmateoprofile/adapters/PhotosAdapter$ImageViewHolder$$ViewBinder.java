...
public class PhotosAdapter$ImageViewHolder$$ViewBinder<T extends PhotosAdapter.ImageViewHolder> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends PhotosAdapter.ImageViewHolder> implements Unbinder {
    protected T target;
