...
public class LoginDialogFragment$$ViewBinder<T extends LoginDialogFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends LoginDialogFragment> implements Unbinder {
    protected T target;
