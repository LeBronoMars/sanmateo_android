...
public class AlertLevelActivity$$ViewBinder<T extends AlertLevelActivity> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends AlertLevelActivity> implements Unbinder {
    protected T target;
