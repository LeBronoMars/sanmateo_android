...
public class PreviousNewsEventsFragment$$ViewBinder<T extends PreviousNewsEventsFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends PreviousNewsEventsFragment> implements Unbinder {
    protected T target;
