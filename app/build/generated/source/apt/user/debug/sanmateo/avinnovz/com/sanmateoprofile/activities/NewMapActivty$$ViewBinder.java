...
public class NewMapActivty$$ViewBinder<T extends NewMapActivty> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends NewMapActivty> implements Unbinder {
    protected T target;
