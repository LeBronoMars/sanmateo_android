...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        PanicContactDao.createTable(db, ifNotExists);
        CurrentUserDao.createTable(db, ifNotExists);
        LocalGalleryDao.createTable(db, ifNotExists);
        LocalOfficialDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        PanicContactDao.dropTable(db, ifExists);
        CurrentUserDao.dropTable(db, ifExists);
        LocalGalleryDao.dropTable(db, ifExists);
        LocalOfficialDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(PanicContactDao.class);
        registerDaoClass(CurrentUserDao.class);
        registerDaoClass(LocalGalleryDao.class);
        registerDaoClass(LocalOfficialDao.class);
    }
