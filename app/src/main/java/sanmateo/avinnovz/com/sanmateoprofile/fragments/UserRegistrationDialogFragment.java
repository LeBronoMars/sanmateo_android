...
public class UserRegistrationDialogFragment extends DialogFragment {
    ...
    public static UserRegistrationDialogFragment newInstance() {
        final UserRegistrationDialogFragment fragment = new UserRegistrationDialogFragment();
        return fragment;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        etEmail.setText("rsbulanon@gmail.com");
