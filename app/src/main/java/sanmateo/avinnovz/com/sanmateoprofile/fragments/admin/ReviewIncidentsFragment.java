 ...
 */
public class ReviewIncidentsFragment extends Fragment implements OnApiRequestListener {
    ...
    public static ReviewIncidentsFragment newInstance() {
        final ReviewIncidentsFragment fragment = new ReviewIncidentsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (PrefsHelper.getBoolean(getActivity(),"refresh_incidents") && incidentsSingleton.getIncidents().size() > 0) {
            ...
            apiRequestHelper.getAllIncidents(token,0,null,"for review");
        }
        initIncidents();
        return view;
    }
