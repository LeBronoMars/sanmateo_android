 ...
 */
public class ForApprovalIncidentFragment extends Fragment implements OnApiRequestListener {
    ...
    public static ForApprovalIncidentFragment newInstance() {
        final ForApprovalIncidentFragment fragment = new ForApprovalIncidentFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (PrefsHelper.getBoolean(getActivity(),"refresh_incidents") && incidentsSingleton.getIncidents().size() > 0) {
            ...
            LogHelper.log("approval","must get all");
            apiRequestHelper.getAllIncidents(token,0,null,"for approval");
        }
        initIncidents();
        return view;
    }
